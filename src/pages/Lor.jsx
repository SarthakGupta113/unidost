...
function Lor() {
  ...
  const generatePDF = async () => {
    try {
      const response = await fetch(`http://${process.env.REACT_APP_B_HOST}/generate-pdf`, {
        method: 'POST',
        headers: {
    ...
    <div>
            ...
            <div className='flex w-[90%]'>
                ...
                <div className='w-[75%] pb-6 rounded-r-lg bg-white'>
                    <div className='ml-8 mt-9 font-semibold text-[#3a85e7]   text-2xl'>Letter of Recommendation: Enter your Details</div>
